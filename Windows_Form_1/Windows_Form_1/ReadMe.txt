========================================================================
    應用程式：Windows_Form_1 專案概觀
========================================================================

AppWizard 已經為您建立了這個 Windows_Form_1 應用程式。

這個檔案包含一份摘要，簡要說明構成 Windows_Form_1 應用程式的
所有檔案，它們個別的內容。

Windows_Form_1.vcxproj
    這是使用應用程式精靈所產生之 VC++ 專案的主要專案檔。它含有產生該檔案之 Visual C++ 的版本資訊，以及有關使用應用程式精靈所選取之平台、組態和專案功能的資訊。

Windows_Form_1.vcxproj.filters
